...
resource "aws_cognito_user_pool" "user_pool" {
  name = "${var.prefix}-${var.env}-user-pool"
...
resource "aws_cognito_user_pool_client" "pool_client" {
  name            = "${var.prefix}-${var.env}-pool-client"
...
resource "aws_cognito_identity_pool" "id_pool" {
  identity_pool_name               = "${var.prefix}_${var.env}_idpool"
...
/*  
  role_mapping {
    ...
    identity_provider         = "cognito-idp.${var.aws_region}.amazonaws.com/${aws_cognito_user_pool.user_pool.id}:${aws_cognito_user_pool_client.pool_client.id}"
    type                      = "Token"
  }
*/
